...
# These fields should NEVER be parsed by extended parser
CORE_FIELDS = {
    "Genus","Species","Gram Stain","Shape","Colony Morphology","Haemolysis","Haemolysis Type",
    "Motility","Capsule","Spore Formation","Growth Temperature","Oxygen Requirement","Media Grown On",
    "Catalase","Oxidase","Coagulase","DNase","Urease","Citrate","Methyl Red","VP","H2S","ONPG",
    "Nitrate Reduction","Lipase Test","NaCl Tolerant (>=6%)",
    "Lysine Decarboxylase","Ornitihine Decarboxylase","Arginine dihydrolase","Gelatin Hydrolysis",
    "Esculin Hydrolysis",
    "Glucose Fermentation","Lactose Fermentation","Sucrose Fermentation","Mannitol Fermentation",
    "Sorbitol Fermentation","Maltose Fermentation","Xylose Fermentation","Rhamnose Fermentation",
...
# Sensitivity/Resistance lexicon for disk tests
SENS_MAP = {
    "sensitive": "Positive",
...
def parse_text_extended(text: str) -> Dict[str, str]:
    """
    Only extracts fields that exist in extended_schema.json.
    NEVER extracts core tests.
    """
    ...
    for canon_field in ext_schema.keys():
        if canon_field in CORE_FIELDS:
            continue  # safety: avoid ever treating core fields as extended
